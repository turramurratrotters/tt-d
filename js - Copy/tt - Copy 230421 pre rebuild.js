    ...
    function toggleCollapsables(p_id){
        ...
        for (i = 0; i < v_collapsableContent.length; i++) {
            if (v_collapsableContent[i].id == p_id + 'Content'){  
                ...
                if (v_collapsableContent[i].style.display === "grid" || v_collapsableContent[i].style.display === "block") {
                    v_collapsableContent[i].style.display = "none";
                } else {
                    recordMenuClicks(p_id);
                    if (p_id == 'cySchedule'){
                        document.getElementById(p_id).classList.toggle("i06-active-element");          
                        window.location = 'cySchedule.html';
                    } else if (p_id == 'popularEvents') {
                        document.getElementById(p_id).classList.toggle("i06-active-element");          
                        window.location = 'popularEvents.html';
                    } else {
